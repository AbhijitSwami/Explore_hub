...
public class BookMain extends AppCompatActivity implements LoaderManager.LoaderCallbacks <List <Book>> {
    ...
    private static final String LOG_TAG = BookMain.class.getSimpleName();
    ...
    private void initViewsAndData() {
        ...
        mAdapter = new BookArrayAdapter(BookMain.this, bookArrayList);
        ...
        bookQueryView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                ...
                if (isConnected) {
                    ...
                    mLoaderManager.restartLoader(BOOK_LOADER, b, BookMain.this);/*diff between restart loader and init loader: https://stackoverflow.com/q/14445070*/
                } else {
    ...
    public Loader <List <Book>> onCreateLoader(int i, Bundle bundle) {
        ...
        return new BookLoader(BookMain.this, bundle.getString("searchquery"));
    }
